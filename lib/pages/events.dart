...
var date = ['18/05/2023', '15/05/2023 -17/05/2023', '19/05/2023', '15/06/2023', '05/07/2023'];
  var event_events = ['CULTURAL FEST', 'SPORTS EVENTS', 'INTERNSHIP', 'HOLIDAY', 'OTHER'];
    var description = [' Co-curricular activities are activities that take place outside the classroom but reinforce or supplement classroom curriculum in some way', 'Physical contests pursued for the goals and challenges they entail. Sports are part of every culture past and present', 'Internships is a portal that connects students and graduates to entrepreneurial workplacements (enternships) in start-ups and small businesses worldwide', 'List of Public and Government Holidays ', 'All other updates'];
